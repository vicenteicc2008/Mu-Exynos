# @file
# Script to Build Galaxy J7 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("j7Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('j7', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "j7Pkg/j7.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "j7", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "j7Pkg/j7.dsc", "Platform Hardcoded")
