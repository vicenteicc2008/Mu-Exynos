...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("a30Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a30', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "a30Pkg/a30.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "a30", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "a30Pkg/a30.dsc", "Platform Hardcoded")
